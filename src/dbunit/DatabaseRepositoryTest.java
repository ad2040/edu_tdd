...
public class DatabaseRepositoryTest {
	...
	public void testFindById() throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException{
		Seller expectedSeller = new Seller("nam", "남택일", "ad2040@gmail.com");
		Seller expectedSeller1 = new Seller("kim", "김명숙", "kim@gmail.com");
		Seller expectedSeller2 = new Seller("lee", "이종민", "lee@gmail.com");
